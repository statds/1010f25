...
This chapter reviews operating systems, files, folders, paths,
terminals; installing R, Positron/RStudio, and Quarto.
...
## Install R, Positron (or RStudio), and Quarto {#sec-quarto}

1. Install R from [CRAN](https://CRAN.R-project.org). 
2. Install [Positron](https://positron.posit.co) or [RStudio Desktop](https://posit.co/download/rstudio-desktop/).
