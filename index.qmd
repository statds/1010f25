...
<!-- Many data science teams are composed of professionals from varied -->
<!-- backgrounds. These individuals work together to identify and answer -->
<!-- interesting business and research questions using data. Participating -->
<!-- in this group project will give you insight into working on a data -->
<!-- science team, and working through the Tidy Data Workflow to transform -->
<!-- a set of questions into a well-designed product that communicates -->
<!-- clear findings. -->
