...
After learning about `anti_join()`, we can now check how many flights
lack corresponding aircraft information:
...
Text data are common in real datasets. Variables such as airline
names, airport codes, or weather descriptions are stored as
strings. Learning how to inspect, clean, and manipulate string
...
```{r}
flights %>%
  mutate(arr_dt = make_datetime(year, month, day, arr_time %/% 100, arr_time %% 100),
         delay_mins = as.numeric(difftime(arr_dt, dep_dt, units = "mins"))) %>%
